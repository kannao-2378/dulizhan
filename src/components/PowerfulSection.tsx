...
function StatCard({
  ...
  return (
    <div className="flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-white/5 px-8 py-10 backdrop-blur-sm">
      ...
      >
        <div className="overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40">
            ...
            <p className="mt-4 max-w-xl text-center text-lg leading-relaxed text-gray-200">
              A powerful motor delivers the torque you need on every hill—no
              sweat, just smooth riding.
            </p>
          </div>
        </div>
      </div>
